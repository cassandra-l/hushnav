...
export function Home() {
  ...
  return (
    <main className="min-h-screen font-sans text-[#1E2939] flex flex-col overflow-hidden">
      {/* Navigation Bar */}
      <nav className="flex items-center justify-between px-6 py-6 lg:px-8 max-w-[1440px] mx-auto w-full z-20">
