...
export function SupportPage() {
  ...
  <div className="w-full max-w-sm rounded-[2.5rem] bg-white p-8 shadow-2xl shadow-gray-200/50">
    {/* flexible container for the title + icon + additional subtext*/}  
    <div className="flex flex-col items-start gap-4">
      {/* creating the header sections for the icon and for the label*/}  
      <div className="flex items-center gap-4">
        {/* container for the icon*/}  
        <div className="flex h-12 w-12 items-center justify-center rounded-full bg-teal-50 text-[#5A9A8E]">
          {/* adding the wind icon into the icon container*/}           
        ...
        <div>
          {/* title and the subtext under the title*/}  
