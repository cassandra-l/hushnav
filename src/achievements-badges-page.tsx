...
export function AchievementsBadgesPage() {
  ...
  return (
    <main className="min-h-screen w-full bg-linear-to-b from-[#F0F4F3] via-[#EDF2F1] to-[#EBF0EE]">
      {/* Header */}
        ...
        <div className="mb-8 flex gap-2 overflow-x-auto pb-3 no-scrollbar lg:mb-10">
          {filterChips.map((chip) => (
            <button
              ...
              className={`
                hover:bg-[#f0f0f0] cursor-pointer whitespace-nowrap rounded-full px-5 py-1.5 text-[13px] font-medium transition-all border lg:px-6 lg:py-2 lg:text-sm
                ${
        ...
        >
          ...
          >
            ...
            <div className="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-[#E8EDF1] text-4xl shadow-inner">
              <span
                className={selectedBadge.unlocked ? "" : "grayscale opacity-50"}
              >
                {selectedBadge.emoji}
              </span>
            </div>
