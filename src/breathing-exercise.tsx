  ...
  const instructionText = isPreparing
    ...
    : phase === "In"
      ...
      : phase === "Hold"
        ...
        : 'Exhale slowly through your mouth with a soft "whoosh"';
    ...
    <div className="fixed inset-0 z-[100] flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#EAF6F3] px-5 py-6 font-sans text-[#1E2939]">
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center justify-center text-center">
        ...
        */}
        ...
        <div className="mt-7 max-w-sm rounded-3xl border border-white/80 bg-white/50 backdrop-blur-3xl px-5 py-4 text-center text-sm leading-6 text-[#4B5563] shadow-sm">
          <p>
            Follow the bubble as it expands, pauses, and softens. Breathe in as
            it grows, hold gently while it stays still, then exhale as it
            becomes smaller.
          </p>
        </div>
      </div>
